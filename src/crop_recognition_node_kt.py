...
sys.path.append('/home/jetpack513/weed_ws/src/crop_recognition/src')
import network
# import utils
...
class CropRecognitionNode:
    ...
    def publish_stalk_position(self):
        ...
        while self.stalk_positions and self.stalk_count < len(self.stalk_positions):
            ...
            command.data = [(cX - 160) / 1.5, cY / 1.5, max_depth,0]
            # command.data[0] = (cX-160)/1.5 #640×480用に補正
            # command.data[1] = cY/1.5 #640×480用に補正
            # command.data[2] = max_depth
